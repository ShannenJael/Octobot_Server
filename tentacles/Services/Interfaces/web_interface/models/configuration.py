...
def get_default_exchange():
    config = interfaces_util.get_edited_config()
    if config and commons_constants.CONFIG_EXCHANGES in config and config[commons_constants.CONFIG_EXCHANGES]:
        return next(iter(config[commons_constants.CONFIG_EXCHANGES].keys()))
