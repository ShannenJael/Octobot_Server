    ...
    def get_user_inputs(
        ...
        return {
            self.EXCHANGE: UI.user_input(
                self.EXCHANGE, commons_enums.UserInputTypes.TEXT, "cryptocom", inputs,
                title="Exchange: exchange to watch price on. Example: cryptocom. Leave empty to enable on all exchanges.",
